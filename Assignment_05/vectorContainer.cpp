...
void vectorContainer::vectorMain()
{
    vector<student> v2;
...
bool vectorContainer::emptyVector()
{
...
int vectorContainer::amountReserve()
{
    int amount = inputInteger("\n\tEnter the capacity(1...100): ");
    return amount;
}
int vectorContainer::amountResize()
{
    int amount = inputInteger("\n\tEnter the new size(1...100): ");
    return amount;
}

void vectorContainer::readAndStoreData(vector<student>& studentRecord)
{
    ifstream inFile;
...
void vectorContainer::vectorIndex()
{
...
void vectorContainer::beginAndEndIterator()
{
...
void vectorContainer::rBeginAndrEndIterator()
{
...
void vectorContainer::eraseBeginAndEnd()
{
...
void vectorContainer::insertElement()
{
    student temp;
...
void vectorContainer::swapVector(vector<student>& v2)
{
    if (v2.size() == 0)
